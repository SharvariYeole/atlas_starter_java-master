...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ConnectionString mongoUri = new ConnectionString("mongodb+srv://Sharvari:EknathKalbandhe@atlascluster.nfihdq0.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster");
